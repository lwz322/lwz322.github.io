...
既然开启了外网访问，而外网访问的网络环境未知，还是开启HTTPS会相对安全，这里参考了[LEDE申请并部署Let's encrypt证书的教程](https://koolshare.cn/thread-126778-1-1.html)，使用的是[Neilpang/acme.sh](https://github.com/Neilpang/acme.sh/wiki/)的脚本和阿里云的域名，使用acme.sh实现了acme协议, 可以从letsencrypt生成免费的证书，个人根据18.06的情况精简了下
