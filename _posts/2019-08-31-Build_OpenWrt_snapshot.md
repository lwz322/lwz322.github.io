...
<!--more-->
**Update**:截至2019年11月14日，OpenWrt 19.07 rc1已经发布了，另外还有18.06.5，这次更新应该还是会修复不少问题吧（因为上个版本的问题实在是比较多）

找个时间刷了下OpenWrt 19.07 rc1，WEB界面的流畅度确实比18.06有提高，卡片化的二级设置界面也被加入到这次更新，另外之前用了很多年的Favcion被换掉了
## 硬件
