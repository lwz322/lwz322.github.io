...
400Mbps网速成就达成！主要介绍单线多拨，多线多拨以及使用IPv6负载均衡的一个简单的配置方法，也为这些配置方法写了脚本，节约配置的时间，另外还使用了
...
我编译了下，看起来还不错，配置起来算是非常友好了，然而本文适合更加极限一点的情况，IPv6多拨针对NAT6（我还是关掉了mwan3的服务）
...
下面这段只在K2P OpenWrt 18.06上面实践过，而LEDE17.01无效，可能的原因是IPv6负载均衡是MWAN3更新之后添加的功能，在学校个人还是觉得IPv6多拨最实用，因为IPv6不计流量，多数情况下是用来挂机的，不用考虑延迟，也更加容易探到链路带宽的天花板，但是配置mwan软件的负载均衡又相对麻烦，这里又一种偶然发现的简单的方法
