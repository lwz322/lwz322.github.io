...
至于为什么要懂一点点原理，因为本文中所写的方法在学校是最简单的，然而实际中遇到什么情况都有可能，所以也就没有什么最好的方法了，这点可以参考第二个参考链接里的 2018 Version，原理依旧适用，只是实现方法和侧重点略有不同，而在第三个参考链接中的方法则被描述为：The solution provided here can be considered more robust and portable，下文给出的方法参考了网络上的各种文章并且细查了原理，实际用了很长一段时间被证明是稳定可行的
