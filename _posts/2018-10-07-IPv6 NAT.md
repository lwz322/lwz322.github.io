...
> **OpenWrt的接口**
> OpenWrt在LuCI里面的接口很多，从硬件接口如有线网卡eth0，无线网卡wlan0，到VLAN的虚拟网卡eth0.1,eth0.2，再到由macvlan在VLAN上虚拟的网卡veth1，veth2，以及建立在虚拟网卡上的虚拟设备pppoe-wan，建立在eth0.1与wlan0上的网桥br-lan，还有pppoe-wan上做DHCPv4 Client的wan，DHCPv6 Client的wan_6 ,具体可以参考[Linux Network Interfaces
