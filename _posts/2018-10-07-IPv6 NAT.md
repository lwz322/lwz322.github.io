...
<<<<<<< HEAD
至于为什么要懂一点点原理，因为本文中所写的方法在学校是最简单的，然而实际中遇到什么情况都有可能，可以参考第二个参考链接里的 2018 Version，原理依旧适用，只是实现方法略有不同，在第三个参考链接中的方法则被描述为：The solution provided here can be considered more robust and portable，不过代码比较长，受限于时间和机遇，我也就没有试过了，不过最近又发现18.06.1貌似可以省去配置路由表的步骤，之后详尽测试之后再更新吧
=======
...
## 参考
<<<<<<< HEAD
看的方法比较多，列的不全，部分也根据自己对OpenWRT的一些理解做了适当的修改，以上其实也没什么原创，尽是注释
=======
