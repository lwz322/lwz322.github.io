...
而实际上来自下级设备的数据包发送的时候的流程可见[wiki/Iptables](https://en.wikipedia.org/wiki/Iptables)
...
**注**：Hotplug功能实际上是相当的实用的，[OpenWRT Hotplug原理分析](https://github.com/wywincl/hotplug) 这篇文章做了详细的剖析
