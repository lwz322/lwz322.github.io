...
- 11月底，迎来了0.7更新，带来了分屏，可拖动的标签，更美观的边框（窄边框），终端内默认支持中文输入

边框问题在Github上早就有issue了，之前不得不使用深色的背景和较低的透明度来掩盖这个问题，更新之后算是可以直接用了吧，对比如下
![](https://i.loli.net/2019/11/28/p3dkGDO9Y6ZxSI5.png)
