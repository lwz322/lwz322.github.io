...
![Frequency](https://img.vim-cn.com/ad/ac2f52ac58c4b7ce1e1b8ad76b17ae189120c6.svg)

在Linux下，识别加上解析一次需要大约0.6s，测试中最坏的情况需要10s以上，并且概率也不是那么小，所以为了体验还是要优化一下的，一种是用多线程，另外一种就是对需要的识别次数较多的情况直接更换验证码，我的参数就是大概设置了个值，差不多普遍比较快就行了，具体这个还是可以讨论下，毕竟图像的识别率还是有限的。
